...
public final class Cores implements Iterable<CpuState>, Serializable
{
    ...
    /**
     * Adds a given {@link CpuState} to this {@link Cores} {@link List}.
     * 
     * @param cpu
     *            a {@link CpuState} instance to be added. May not be <code>null</code>.
     * @return the old instance of the given {@link CpuState} or <code>null</code> if there wasn't one.
     */
