...
{
    private static transient final Logger LOGGER = LoggerFactory.getLogger(HardwareBuilder.class.getName());
    ...
    public static Machine machine()
    {
        ...
        {
            LOGGER.error("Error on building the machine. Error message [{}]", e.getMessage());   
        }
